  ...
  return (
    <div className="bg-black text-white py-[72px] sm:p-24 text-center overflow-hidden" ref={containerRef}>
      <div className="container max-w-xl relative ">
        ...
        <h2 className="font-bold text-5xl sm:text-6xl tracking-tighter">Boost Your Telegram Community</h2>
        <p className="text-xl text-white/70 mt-5">
          Start using TeleGage today and transform your Telegram group into a thriving, engaged community with Web3 rewards.
        </p>
        <form className="mt-10 flex flex-col sm:flex-row gap-2.5 max-w-md mx-auto">
          ...
          <button className="bg-white text-black h-12 rounded-lg px-5">Get TeleGage</button>
        </form>
      </div>
    </div>
  );
